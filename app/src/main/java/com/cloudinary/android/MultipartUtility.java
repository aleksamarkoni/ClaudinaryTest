...
public class MultipartUtility {
     ...
     * @throws IOException
     */
    public MultipartUtility(String requestURL, String charset, String boundary, Map<String, String> headers, Uploader uploader) throws IOException {
    ...
    public MultipartUtility(String requestURL, String charset, String boundary, Uploader uploader) throws IOException {
        this(requestURL, charset, boundary, null, uploader);
    }
    ...
    public void addFilePart(String fieldName, InputStream inputStream, String fileName) throws IOException {
        ...
        while ((bytesRead = inputStream.read(buffer)) != -1) {
            ...
            progress += bytesRead;
            UploadCallback uploadCallback = this.uploader.getUploadCallback();
            if(uploadCallback != null) {
                uploadCallback.uploadListener(progress);
            }
            outputStream.flush();
            writer.flush();
        }
